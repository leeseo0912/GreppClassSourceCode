...
// java.lang 패키지는 따로 import문을 선언하지 않아도 자동으로 import
// java.lang : 자바로 프로그래밍할 때 가장 많이 사용할 클래스들을 모아놓은 그룹
// full qualified name 대신 클래스명을 사용하기 위해 밀리 full qualified name을 선언
import java.util.Scanner;

// NOTE CB00 Package : 연관된 클래스들의 그룹
// Java에서 full qualified name은 중복될 수 없다.
// 패키지명 : com.grepp.basic.c_prepare
// 클래스명 : B_Scanner
// full qualified name : com.grepp.basic.c_prepare.B_Scanner(메모리가 관리하는 Class 이름)
...
public class B_Scanner {
  ...
  public static void main(String[] args) {
    ...
    // sc.next()
    // 1. 사용자의 입력을 대기한다.
    // 2. 입력된 값을 공백문자를 기준으로 나누어(토큰) 하나씩 반환한다.
