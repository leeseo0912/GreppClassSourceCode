...
// class 이름 == type 이름
// 객체 생성 이후 인스턴스변수을 초기화 하지 않으면 JVM의 기본값으로 초기화
// 숫자 타입 : 0
// 참조형 타입 : null
// 문자형 타입 : 유니코드 0번
// 논리형 타입 : false
...
public class Coffee {
  ...
  // NOTE G02 생성자
  // 생성자 : 사용자정의타입을 heap영역의 메모리에 올릴 때, 인스턴스변수를 초기화 하기 위해 사용하는 메서드
  // 생성자를 하나도 생성하지 않으면, java의 컴파일러가 기본생성자(매개변수가 0개)를 자동으로 생성 해줌
//  public Coffee(){
